var API_URL = '/api/typ02/openApi/VilageFcstInfoService_2.0/getUltraSrtFcst';
...
function fetchWeatherData() {
    ...
    var url = `${API_URL}?pageNo=1&numOfRows=1000&dataType=JSON&base_date=${base_date}&base_time=${base_time}&nx=${nx}&ny=${ny}`;
